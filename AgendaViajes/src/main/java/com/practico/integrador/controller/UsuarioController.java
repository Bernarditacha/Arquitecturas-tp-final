...
public class UsuarioController {
	 ...
	 public UsuarioController(@Qualifier("usuarioRepository") UsuarioRepository repository) {
	    ...
	    //Permite recuperar a determinado usuario con pass y contrasenia
	    @GetMapping("/findByUsuarioAndContrasenia")
	    public List<Usuario> findByUsuarioAndContrasenia(@PathVariable String usuario, @PathVariable String contrasenia ) {
